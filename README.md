...
The first background-removal run downloads the ORMBG model. Later runs reuse both the browser cache and the already-open worker, making repeat cutouts much faster. Select a product on the board to switch between **Original** and **Cutout**, or retry removal.
